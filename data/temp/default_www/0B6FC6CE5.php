...
<head>
    ...
    <title><?php echo((is_array($_title) ? join('_', $_title) : $_title));?>434343</title>
    <!--[if lt IE 9]>
    <meta http-equiv="refresh" content="0;ie.html" />
    <![endif]-->
    <link rel="shortcut icon" href="favicon.ico">
    <link href="http://admin.ipasswallet.d/template/style/css/bootstrap.min14ed.css?v=3.3.6" rel="stylesheet">
    <link href="http://admin.ipasswallet.d/static/font-awesome/css/font-awesome.css?v=4.7.0" rel="stylesheet">
    <link href="http://admin.ipasswallet.d/template/style/css/animate.min.css" rel="stylesheet">
    <link href="http://admin.ipasswallet.d/template/style/css/style.min862f.css?v=4.1.0" rel="stylesheet">
    <link href="http://admin.ipasswallet.d/template/style/css/bids.css?v=1.0.0" rel="stylesheet">
    <script type="text/javascript">
        var upload_image_url = '<?php echo(RGX\router::url('@upload-image')); ?>',
            DATA_URL    = 'http://admin.ipasswallet.d/data/',
            STATIC_URL  = 'http://admin.ipasswallet.d/static/',
            UPLOAD_URL  = 'http://admin.ipasswallet.d/data/attachment/',
            ...
            <li class="nav-header" style="text-align: center">
                <div class="dropdown profile-element">
                    <a href="javascript:;" data-href="<?php echo(RGX\router::url('account-add-id-%d' , $login['admin_id'])); ?>">
                        <span class="clear">
                           <span class="block m-t-xs"><strong class="font-bold" style="font-size: 14px;">iPassWallet管理</strong></span>
                           <span class="text-muted text-xs block" style="font-size: 12px;">&nbsp;</span>
                        </span>
                    </a>
                </div>
                <div class="logo-element">富</div>
...
<!--右侧部分开始-->
                    ...
                    <div class="navbar-header hide">
                        ...
                        <form role="search" class="navbar-form-custom" action="<?php echo(RGX\router::url('employee-list~')); ?>" method="get" target="iframe0">
                            ...
                            <div class="form-group">
                                <input type="text" placeholder="请输入雇员关键字 …" class="form-control" name="skey" id="top-search">
                            </div>
                        </form>
                    </div>
    ...
    <script src="http://admin.ipasswallet.d/template/style/js/jquery.min.js?v=2.1.4"></script>
    <script src="http://admin.ipasswallet.d/template/style/js/bootstrap.min.js?v=3.3.6"></script>
    <script src="http://admin.ipasswallet.d/template/style/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="http://admin.ipasswallet.d/template/style/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="http://admin.ipasswallet.d/template/style/js/plugins/layer/layer.min.js"></script>
    <script src="http://admin.ipasswallet.d/template/style/js/hplus.min.js?v=4.1.0"></script>
    <script src="http://admin.ipasswallet.d/template/style/js/contabs.min.js"></script>
    <script src="http://admin.ipasswallet.d/template/style/js/plugins/pace/pace.min.js"></script>
    <script src="http://admin.ipasswallet.d/static/js/RGX.lib.min.js"></script>
    <script type="text/javascript">
        $(function(){
