...
<head>
    ...
    <link href="http://matchmaking.d/template/style/css/login.min.css" rel="stylesheet">
    <style type="text/css" media="screen">
        body.signin{
            height:auto;
            background:url(http://matchmaking.d/template/style/img/bg1.jpg);
        ...
        <div class="row">
            ...
            <div class="col-sm-5">
                <form method="post" id="login-form" action="<?php echo(RGX\router::url('login')); ?>" autocomplete="off">
                    <h4 class="no-margins">iMatchmaking 管理系统</h4>
